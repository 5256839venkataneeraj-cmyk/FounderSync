    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          ...
          <div className="bg-white p-4 rounded-lg border border-slate-200 shadow-sm">
            <p className="text-xs font-medium text-slate-500">Annual Recurring Revenue</p>
          ...
          {/* Monthly Churn Rate */}
          <div className="bg-white p-4 rounded-lg border border-slate-200 shadow-sm">
            <p className="text-xs font-medium text-slate-500">Monthly Churn Rate</p>
            <p className="text-xl font-bold text-slate-900 mt-1">
          ...
          {/* LTV */}
          <div className="bg-white p-4 rounded-lg border border-slate-200 shadow-sm">
            <p className="text-xs font-medium text-slate-500">Customer Lifetime Value</p>
            <p className="text-xl font-bold text-slate-900 mt-1">
          ...
          {/* Monthly Burn Rate */}
          <div className="bg-white p-4 rounded-lg border border-slate-200 shadow-sm">
            <p className="text-xs font-medium text-slate-500">Monthly Burn Rate</p>
            <p className="text-xl font-bold text-slate-900 mt-1">
      ...
      <div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {/* Team Burnout Index */}
          <div className="bg-white p-4 rounded-lg border border-slate-200 shadow-sm">
            <p className="text-xs font-medium text-slate-500">Team Burnout Index</p>
            <p className="text-xl font-bold text-slate-900 mt-1">
          ...
          <div className="bg-white p-4 rounded-lg border border-slate-200 shadow-sm">
            <p className="text-xs font-medium text-slate-500">Customer Trust Score</p>
            <p className="text-xl font-bold text-slate-900 mt-1">
          ...
          <div className="bg-white p-4 rounded-lg border border-slate-200 shadow-sm">
            <p className="text-xs font-medium text-slate-500">Founder Cognitive Load</p>
            <p className="text-xl font-bold text-slate-900 mt-1">
          ...
          {/* Retention Sentiment */}
          <div className="bg-white p-4 rounded-lg border border-slate-200 shadow-sm">
            <p className="text-xs font-medium text-slate-500">Retention Sentiment</p>
            <p className="text-xl font-bold text-slate-900 mt-1">
