      ...
      <div className="relative w-full max-w-lg bg-linear-to-b from-white to-slate-50 border border-slate-200 rounded-3xl p-6 sm:p-10 shadow-2xl space-y-6 overflow-hidden">
        ...
        <div className="bg-white rounded-2xl border border-slate-200/80 p-6 shadow-xs space-y-4">
          ...
          <button
            type="button"
            onClick={onClose}
            className="w-full flex items-center justify-center gap-3 bg-white hover:bg-slate-50 border border-slate-300 rounded-xl py-2.5 px-4 text-xs font-bold text-slate-700 shadow-xs transition-colors"
          >
